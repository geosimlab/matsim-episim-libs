 ...
 */
public final class HouseholdSecularUltraContactModel extends AbstractContactModel {

	private static final Logger log = LogManager.getLogger(HouseholdSecularUltraContactModel.class);
	...
	@Inject
	HouseholdSecularUltraContactModel(SplittableRandom rnd, Config config,
