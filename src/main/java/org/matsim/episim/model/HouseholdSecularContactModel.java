 ...
 */
public final class HouseholdSecularContactModel extends AbstractContactModel {

	private static final Logger log = LogManager.getLogger(HouseholdSecularContactModel.class);
	...
	@Inject
	HouseholdSecularContactModel(SplittableRandom rnd, Config config,
