 ...
 */
public final class HouseholdSecularUltraContactModelDate extends AbstractContactModel {

	private static final Logger log = LogManager.getLogger(HouseholdSecularUltraContactModelDate.class);
	...
	@Inject
	HouseholdSecularUltraContactModelDate(SplittableRandom rnd, Config config,
...
//		only haredim infect, andonly haredim are infected
		boolean is1secular= person1.getAttributes().getAttribute("subpopulation").toString().equals("internal_Secular") ;
