 ...
 */
public final class HouseholdContactModel extends AbstractContactModel {

	private static final Logger log = LogManager.getLogger(HouseholdContactModel.class);
	...
	@Inject
	HouseholdContactModel(SplittableRandom rnd, Config config,
