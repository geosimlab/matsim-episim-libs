 ...
 */
public final class HouseholdUltraOrthodoxContactModel extends AbstractContactModel {

	private static final Logger log = LogManager.getLogger(HouseholdUltraOrthodoxContactModel.class);
	...
	@Inject
	HouseholdUltraOrthodoxContactModel(SplittableRandom rnd, Config config,
