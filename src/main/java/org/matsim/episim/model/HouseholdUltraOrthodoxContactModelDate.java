 ...
 */
public final class HouseholdUltraOrthodoxContactModelDate extends AbstractContactModel {

	private static final Logger log = LogManager.getLogger(HouseholdUltraOrthodoxContactModelDate.class);
	...
	@Inject
	HouseholdUltraOrthodoxContactModelDate(SplittableRandom rnd, Config config,
