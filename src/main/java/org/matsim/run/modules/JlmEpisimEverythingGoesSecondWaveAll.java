 ...
 */
public class JlmEpisimEverythingGoesSecondWaveAll extends AbstractModule {
	private static final Logger log = Logger.getLogger(JlmEpisimEverythingGoesSecondWaveAll.class);
	...
	public static void setDaysUntilInfections(int daysUntilInfections) {
		JlmEpisimEverythingGoesSecondWaveAll.daysUntilInfections = daysUntilInfections;
	}
