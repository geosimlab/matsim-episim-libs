 ...
 */
public class JlmEpisimEverythingGoesFirstWaveSecularUltra10DailyInflow extends AbstractModule {
	private static final Logger log = Logger.getLogger(JlmEpisimEverythingGoesFirstWaveSecularUltra10DailyInflow.class);
...
//		LocalDate date = startDate;
		...
		int[] diseaseimport = {10,10,8,15,11,13,13,9,15,9,9,9,15,7,11,8,12,18,6,16,12,10,4,8,10,16,9,6,14,5,5,5,9,8,6,8,6,9,6,11,11,11,9,8,10,12,12,13,8,8,6,7,9,11,9,11,8,6,13,9,8,15,5,8,10,13,9,7,9,14,10,7,12,13,11,13,8,12,8,11,10,13,15,5,10,12,14,10,7,8};
