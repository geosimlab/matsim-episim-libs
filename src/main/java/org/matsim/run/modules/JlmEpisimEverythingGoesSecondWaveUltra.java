 ...
 */
public class JlmEpisimEverythingGoesSecondWaveUltra extends AbstractModule {
	private static final Logger log = Logger.getLogger(JlmEpisimEverythingGoesSecondWaveUltra.class);
	...
	public static void setDaysUntilInfections(int daysUntilInfections) {
		JlmEpisimEverythingGoesSecondWaveUltra.daysUntilInfections = daysUntilInfections;
	}
