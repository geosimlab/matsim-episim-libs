 ...
 */
public class JlmEpisimEverythingGoesSecondWaveSecularUltraClosureUltra extends AbstractModule {
	private static final Logger log = Logger.getLogger(JlmEpisimEverythingGoesSecondWaveSecularUltraClosureUltra.class);
	...
	public static void setDaysUntilInfections(int daysUntilInfections) {
		JlmEpisimEverythingGoesSecondWaveSecularUltraClosureUltra.daysUntilInfections = daysUntilInfections;
	}
