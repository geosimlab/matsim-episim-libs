 ...
 */
public class JlmEpisimEverythingGoesSecondWaveSecular extends AbstractModule {
	private static final Logger log = Logger.getLogger(JlmEpisimEverythingGoesSecondWaveSecular.class);
	...
	public static void setDaysUntilInfections(int daysUntilInfections) {
		JlmEpisimEverythingGoesSecondWaveSecular.daysUntilInfections = daysUntilInfections;
	}
