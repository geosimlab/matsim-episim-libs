 ...
 */
public class JlmEpisimEverythingGoesFirstWaveSecularUltra extends AbstractModule {
	private static final Logger log = Logger.getLogger(JlmEpisimEverythingGoesFirstWaveSecularUltra.class);
...
//		episimConfig.setSnapshotSeed(SnapshotSeed.reseed);
		...
		double group_secular_a_open_rate_closing_date = 0.85;
