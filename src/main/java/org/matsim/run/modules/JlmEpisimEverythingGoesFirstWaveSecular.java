 ...
 */
public class JlmEpisimEverythingGoesFirstWaveSecular extends AbstractModule {
	private static final Logger log = Logger.getLogger(JlmEpisimEverythingGoesFirstWaveSecular.class);
