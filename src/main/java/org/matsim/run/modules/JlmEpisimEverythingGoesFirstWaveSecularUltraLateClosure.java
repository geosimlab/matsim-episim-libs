 ...
 */
public class JlmEpisimEverythingGoesFirstWaveSecularUltraLateClosure extends AbstractModule {
	private static final Logger log = Logger.getLogger(JlmEpisimEverythingGoesFirstWaveSecularUltraLateClosure.class);
