 ...
 */
public class JlmEpisimEverythingGoesFirstWaveSecularUltraSmallUltraHouse extends AbstractModule {
	private static final Logger log = Logger.getLogger(JlmEpisimEverythingGoesFirstWaveSecularUltraSmallUltraHouse.class);
	...
	public static void addDefaultParams(EpisimConfigGroup episimConfig) {
		...
		episimConfig.getOrAddContainerParams("home_ultra-orthodox").setContactIntensity(0.33333333333).setSpacesPerFacility(1);
...
//		episimConfig.setSnapshotSeed(SnapshotSeed.reseed);
		...
		double group_secular_a_open_rate_closing_date = 0.9;
