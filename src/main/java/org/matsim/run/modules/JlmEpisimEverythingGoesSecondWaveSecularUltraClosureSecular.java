 ...
 */
public class JlmEpisimEverythingGoesSecondWaveSecularUltraClosureSecular extends AbstractModule {
	private static final Logger log = Logger.getLogger(JlmEpisimEverythingGoesSecondWaveSecularUltraClosureSecular.class);
	...
	public static void setDaysUntilInfections(int daysUntilInfections) {
		JlmEpisimEverythingGoesSecondWaveSecularUltraClosureSecular.daysUntilInfections = daysUntilInfections;
	}
