...
public class JlmEpisimEverythingGoes extends AbstractModule {
	...
	final public static String RUN_ID = "/" + 62 + "/" + 1;
	/**
...
//		more general restrictions
		...
		double group_a_open_rate_opening_date = 0.9;
		double group_b_open_rate_opening_date = 1;
		LocalDate closingDate2 = LocalDate.of(2020, 7, 6);
		double group_a_open_rate_closing_date2 = 0.5;
