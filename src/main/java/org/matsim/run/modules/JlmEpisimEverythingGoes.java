...
public class JlmEpisimEverythingGoes extends AbstractModule {
	...
	final public static String RUN_ID = "/" + 111 + "/" + 1;
	final public static int iterations = 400;
	final public static double ultraOrthodoxInfectionRate = 1.1;
	...
	public Config config() {
		...
		double group_a_open_rate_closing_date2 = 0.6;
		...
		double group_a_open_rate_closing_date4 = 0.6;
...
//		double group_b_open_rate_closing_date9 = 1;
		episimConfig.setPolicy(FixedPolicy.class, FixedPolicy.config()
				...
				.restrict(closingDate7 , group_a_open_rate_closing_date7 , group_secular_a_activities)
...
//				.restrict(closingDate9 , group_b_open_rate_closing_date9 , group_secular_b_activities)
				...
				.restrict(closingDate7 , group_a_open_rate_closing_date7 , group_ultra_a_activities)
