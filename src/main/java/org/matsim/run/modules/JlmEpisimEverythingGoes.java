...
public class JlmEpisimEverythingGoes extends AbstractModule {
	...
	final public static String RUN_ID = "/" + 150 + "/" + 1;
...
//		episimConfig.setSnapshotSeed(SnapshotSeed.reseed);
		...
		double group_secular_a_open_rate_closing_date = 0.6;
		double group_ultra_a_open_rate_closing_date = 0.6;
		double group_b_open_rate_closing_date = 1;
//		//		end of first closure
		LocalDate openingDate= LocalDate.of(2020, 5, 5);
		double group_secular_a_open_rate_opening_date = 0.8;
		double group_ultra_a_open_rate_opening_date = 0.8;
