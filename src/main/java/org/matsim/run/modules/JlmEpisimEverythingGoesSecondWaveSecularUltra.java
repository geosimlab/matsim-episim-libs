 ...
 */
public class JlmEpisimEverythingGoesSecondWaveSecularUltra extends AbstractModule {
	private static final Logger log = Logger.getLogger(JlmEpisimEverythingGoesSecondWaveSecularUltra.class);
	...
	public static void setDaysUntilInfections(int daysUntilInfections) {
		JlmEpisimEverythingGoesSecondWaveSecularUltra.daysUntilInfections = daysUntilInfections;
	}
