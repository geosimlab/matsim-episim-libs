 ...
 */
public final class JlmNewPaperScenario extends AbstractModule {
	...
	public static class Builder{
		...
		public JlmNewPaperScenario createSnzBerlinProductionScenario(){
			return new JlmNewPaperScenario( sample, diseaseImport, restrictions, masks, tracing, snapshot, infectionModel, importOffset, vaccinationModel );
		}
	...
	private JlmNewPaperScenario( int sample, DiseaseImport diseaseImport, Restrictions restrictions, Masks masks, Tracing tracing, Snapshot snapshot,
